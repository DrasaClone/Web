            ...
            <div style="display: flex; flex-wrap: wrap;">
                ...
                <div class="modal-right" style="flex: 1; padding: 40px;">
                    ...
                    <div style="margin-top: 40px; padding: 30px; background: var(--neutral); border-radius: var(--radius-md); border: 2px dashed var(--secondary); position: relative;">
                        ...
                        <p style="font-size: 0.9rem; font-style: italic; color: var(--secondary); margin-top: 20px; text-align: center; border-top: 1px solid var(--secondary); padding-top: 15px;">Kỷ niệm riêng: ${student.secretMemory}</p>
                    </div>
                </div>
            </div>
        `;
